...
class KnowledgeArticle(Base):
    ...
    target_help_types_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    target_species_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    target_competency_slugs_json: Mapped[str | None] = mapped_column(Text, nullable=True)
